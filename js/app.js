...
async function initApp() {
    ...
    try {
        ...
        const errorMessage = error.message.includes('backend') || error.message.includes('server')
            ? `${error.message}\n\nTo fix this:\n1. Make sure your Node.js backend is running\n2. Check that it's running on the correct port\n3. Update API_BASE_URL in js/data.js if needed`
